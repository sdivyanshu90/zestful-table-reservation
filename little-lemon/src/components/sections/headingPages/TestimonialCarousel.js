...
export default function CarouselPage() {
    return (
        <Carousel infiniteLoop={true} autoPlay={true} Interval={5000} showStatus={false}>
            ...
            <TestimonialCard name="Rahul" description="Little Lemon restaurant provided an incredible dining experience with 
            inviting ambiance, attentive staff, and delightful dishes bursting with flavors. Highly recommended for a memorable 
